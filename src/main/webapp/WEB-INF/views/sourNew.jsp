...
<div class="container">
	<form:form method="post" modelAttribute="sources" action="addsour" class="form-inline">
	<div class="form-group">
            <label for="">Id</label>
            <br>
            <form:input type="number" class="form-control" path="source_id" placeholder="source_id" value="2019" />
			...
			<div class="form-group">
				...
				<br>
				<form:input path="employee_id" type="text" class="form-control" placeholder="employee_id"  />
				<!-- bind to user.name-->
