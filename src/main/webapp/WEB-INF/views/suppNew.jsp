...
<div class="container">
	<form:form method="post" modelAttribute="suppliers" action="addsupp" class="form-inline">
	<div class="form-group">
			...
			<div class="form-group">
				...
				<br>
				<form:input path="material" type="text" class="form-control" placeholder="material"  />
				<!-- bind to user.name-->
			...
			<br>
				...
				<br>
				<form:input path="site_id" type="number" class="form-control" placeholder="site_id"  />
				<!-- bind to user.name-->
