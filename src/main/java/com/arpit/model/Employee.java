...
public class Employee implements Cloneable, Serializable {
    ...
    public void setEmail_id(String email_idIn) {
          this.email_id = email_idIn;
    }
    ...
    public boolean hasEqualMapping(Employee valueObject) {
          ...
          if (this.email_id == null) {
                    if (valueObject.getEmail_id() != null)
                           return(false);
          } else if (!this.email_id.equals(valueObject.getEmail_id())) {
                    return(false);
          }
    ...
    public String toString() {
        ...
        out.append("email_id = " + this.email_id + "\n"); 
        return out.toString();
    }
    ...
    public Object clone() {
        ...
        if (this.email_id != null)
             cloned.setEmail_id(new String(this.email_id)); 
        return cloned;
    }
